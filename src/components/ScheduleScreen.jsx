...
const TIMETABLE = {
  ...
  Tue: {
    ...
    slots: [
      ...
      { time: "6:00–6:45pm",  label: "Math",                       type: "medium",   tip: "Practice problems. Talk through each step aloud. 45 min.", method: "Practice + Verbal" },
      { time: "6:45–7:00pm",  label: "Movement Break 🏃",          type: "break",    tip: "Dance, stretch, jump around — move your body! 15 min." },
      { time: "7:00–7:45pm",  label: "Math",                       type: "medium",   tip: "Continue with practice problems. Draw diagrams where helpful. 45 min.", method: "Practice + Diagrams" },
  ...
  Wed: {
    ...
    slots: [
      ...
      { time: "5:30–6:00pm",  label: "Homework",                   type: "homework", tip: "30 min.", method: "30 min priority" },
      { time: "6:00–6:45pm",  label: "Geography",                  type: "easy",     tip: "Draw and label maps and diagrams from memory. 45 min.", method: "Drawing + Labelling" },
      { time: "6:45–7:00pm",  label: "Brain Break 🐶",             type: "break",    tip: "Go outside briefly or play with your dog. 15 min." },
      { time: "7:00–7:45pm",  label: "Geography",                  type: "easy",     tip: "Use flashcards for key facts and locations. 45 min.", method: "Flashcards + Key Facts" },
      { time: "7:45–8:00pm",  label: "Water & Snack 💧",           type: "break",    tip: "Drink water. Rest your eyes." },
      { time: "8:00–8:30pm",  label: "Dinner 🍽️",                 type: "routine",  tip: null },
      { time: "8:30–9:15pm",  label: "French",                     type: "hard",     tip: "Flashcards + say words aloud. Quick vocab quiz. 45 min.", method: "Flashcards + Quiz" },
  ...
  Thu: {
    ...
    slots: [
      ...
      { time: "7:00–7:45pm",  label: "English Literature",         type: "easy",     tip: "Discuss characters and themes with a family member. 45 min.", method: "Discussion + Character Maps" },
